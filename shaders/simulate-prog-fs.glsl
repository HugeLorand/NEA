...
void main()
{
        ...
        highp vec4 pixelVector = texture2D(sampler, TexCoordIN);
        if (pixelVector.b > 0.0) {
                ...
                newVel = mat*(adj-disp)*0.375+vel*DampingIN;
        		newDisp = disp+newVel;
        }
